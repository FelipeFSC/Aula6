...
public class TelaPrincipal extends javax.swing.JFrame {
    ...
    private void jMenuItem1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItem1ActionPerformed
        CadastroClienteInterno oloko = new CadastroClienteInterno();
        
        oloko.setPreferredSize(new Dimension(400,600)); // Ajustando o tamanho da tela 
        
        oloko.pack(); // Ajusta os componentes do formulario
        
        oloko.setVisible(true); // Deixa a tela visivel
        
        jDesktopPane1.add(oloko); // Faz a tela aparecer dentro do Desktop
